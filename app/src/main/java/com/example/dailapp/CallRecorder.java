...
public class CallRecorder extends Service {
        ...
        public int onStartCommand(Intent intent, int flags, int startId) {
            ...
            savedNumber=intent.getStringExtra("Phone");
        ...
        public void onCallStateChanged(Context context, int state, String number) {
            ...
            switch (state) {
                case TelephonyManager.CALL_STATE_RINGING:
                    ...
                    recorder.setOutputFile(sampleDir.getAbsolutePath() + "/" + name +"_"+ phone + "_" + time +  " .amr");
                ...
                case TelephonyManager.CALL_STATE_OFFHOOK:
                    if (lastState != TelephonyManager.CALL_STATE_RINGING) {
                        ...
                        recorder.start();
                        recordStarted = true;
                        Toast.makeText(getApplicationContext(), "Your call Records save in CallRecords Folder", Toast.LENGTH_LONG).show();
